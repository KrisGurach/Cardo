  ...
  return (
    <main className="main">
      ...
      <section className="main__nav">
        <Navbar 
          title="Соревнования"
          description="Гранд-финал КАРДО [7] представляет из себя формат международного мероприятия уличной культуры, 
          где проходят финальные соревнования по направлениям: хип-хоп, брейкинг, паркур, фриран, воркаут, кикскутинг, 
          трикинг, граффити, скейтбодинг, BMX, диджеинг на специально оборудованных площадках, где участники будут показывать 
          свои навыки для определения лучших."
          hiddenSection={competitions}/> 
        <Navbar 
          title="Видеоконкурс"
          description="На этапе регистрации участник снимает и выкладывает видеоролик длительностью от 1 до 3 минут. 
          Экспертный совет просматривает и оценивает материал, по результатам на официальном сайте, а также на странице сообщества 
          в социальной сети Вконтакте публикуется список ТОП-48 участников. Участники ТОП-48 получают творческое задание. После выполнения 
          творческого задания будут отобраны ТОП-12 участников. Участники ТОП-12 получают творческое задание на финал в личном кабинете.
          ...
          Победителей Видеоконкурса объявят на Гранд-финале после просмотра и оценивания финального задания."
